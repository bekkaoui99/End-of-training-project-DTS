...
<body>
	...
	<?php $this->load->view('include/navbar_view'); ?>
			...
			<table class="choix">
				<tr>
					...
					<td>
						<?php 
							echo form_radio($ens);
							echo form_label('Formateur', 'ens'); 
						?>
					</td>
					<td>
						<?php 
							echo form_radio($etu);
							echo form_label('Stagiaire', 'etu'); 
						?>
					</td>
					<td>
						<?php 
			...
			<table class="table table-striped">
		    	<thead>
		    		<tr>
		        		...
		        		<th>Email</th>
		        		<th>Access</th>
		        		<th class="ico">Changer le rôle</th>
		...
		<?php elseif($role=='ens'): ?>
			...
			<br>
			<center>
	  			<?php echo "Il y en a : <b>" . $ensInfo->num_rows() . " formateur(s) </b>" ?>
	  			<br><br>
		...
		<?php elseif($role=='etu'): ?>
			...
			<br>
			<center>
	  			<?php echo "Il y en a : <b>" . $etuInfo->num_rows() . " stagiaire(s) </b>" ?>
	  			<br><br>
