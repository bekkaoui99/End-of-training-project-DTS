...
<body>
	...
	<center>
		...
		<h3>Le stagiaire <b><?php echo $info_etu->nom_etu ." ". $info_etu->prenom_etu; ?></b></h3>
		<div class="col-md-6 col-md-offset-3 well" id="etd">
		...
		<?php if(!empty($etuAbsInfo->row(0)->id_absence)): ?>
			...
			<h3>Table d'absence de le stagiaire <b><?php echo $info_etu->nom_etu ." ". $info_etu->prenom_etu; ?></b></h3>
			<br>           
