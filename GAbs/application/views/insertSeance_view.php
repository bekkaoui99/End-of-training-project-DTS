	        ...
	        <div class="panel panel-default">
	            ...
	            <div class="panel-body">
	                ...
	                <div class="form-group">
	                    <label for="name" style="color:black;">Module *</label>
	                ...
	                <div class="form-group">
	                    <label for="subject" style="color:black;">Date *</label>
	                ...
	                <div class="form-group">
	                    <label for="subject"  style="color:black;"  >Heure debut *</label>
					...
					<div class="form-group">
	                    <label for="name" style="color:black;">Heure fin * </label>
	                ...
	                <div class="form-group">
	                    <label for="name" style="color:black;">Type *</label>
