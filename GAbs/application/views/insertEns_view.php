...
<html>
<head>
    <title>Creation d'un compte formateur</title>
	    ...
	    <div class="col-md-6 col-md-offset-3">
	        <div class="panel panel-default">
	            <div class="panel-heading">
	                <h4>Creation d'un compte formateur</h4>
	            </div>
	            <div class="panel-body">
	                ...
	                <div class="form-group">
	                    <label for="name" style="color:black;">Pseudo *</label>
	                ...
	                <div class="form-group">
	                    <label for="subject" style="color:black;">Password *</label>
	                    <input class="form-control" name="password" placeholder="Password" type="password" />
	                    <span class="text-danger"><?php echo form_error('password'); ?></span>
	                </div>

	                <div class="form-group">
	                    <label for="subject" style="color:black;">Confirm Password *</label>
	                    <input class="form-control" name="cpassword" placeholder="Confirm Password" type="password" />
	                    <span class="text-danger"><?php echo form_error('cpassword'); ?></span>
	                </div>
					
					<div class="form-group">
	                    <label for="name" style="color:black;">Prenom</label>
	                ...
	                <div class="form-group">
	                    <label for="name" style="color:black;">Adresse</label>
	                ...
	                <div class="form-group">
	                    <label for="name" style="color:black;">Ville</label>
	                ...
	                <div class="form-group">
	                    <label for="name" style="color:black;">Telephone</label>
